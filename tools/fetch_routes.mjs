...
const places = {
  ...
  弥勒: [24.4139213, 103.4127023], 抚仙湖: [24.673, 102.904], 昆明: [25.039, 102.718],
  ...
  湖泉生态园: [24.4060754, 103.4083208],
  东风韵景区: [24.3165716, 103.3783087],
  石林风景区: [24.8156992, 103.3245807],
  ...
  // 高德 POI 坐标已转换为 WGS-84，与 OSRM 和页面坐标系一致。
  野象谷: [22.1730914, 100.8526807],
  曼掌村: [22.1178026, 100.8432375],
  西双版纳机场: [21.9739, 100.7596],
  太原机场: [37.7469, 112.6284],
  宜昌港九码头: [30.6843459, 111.296791],
  中华鲟研究所: [30.7718029, 111.3074019],
  恩施土司城: [30.3035685, 109.4671652],
  土家女儿城: [30.2708658, 109.4980825],
  甲秀楼: [26.5748767, 106.7159442],
  龙江大桥: [24.8929704, 98.6752455],
  玉龙湖: [23.8989093, 100.0901863],
  告庄西双景: [22.0099198, 100.8202993],
  星光夜市: [22.0079885, 100.8195993],
};

// 方案 A 使用已确认酒店作为每天的真实起终点；当地游也按计划景点顺序计算。
const planA = [
  ['太原', [], '襄阳酒店'],
  ['襄阳酒店', ['三峡大坝', '宜昌港九码头'], '宜昌酒店'],
  ['宜昌酒店', ['中华鲟研究所', '恩施土司城', '土家女儿城'], '恩施酒店'],
  ['恩施酒店', ['恩施大峡谷'], '黔江酒店'],
  ['黔江酒店', ['高过河漂流'], '镇远民宿'],
  ['镇远民宿', ['贵阳民宿', '甲秀楼'], '贵阳民宿'],
  ...
  ['镇宁酒店', ['黄果树瀑布'], '兴义民宿'],
  ['兴义民宿', ['万峰林'], '抚仙湖民宿'],
  ['抚仙湖民宿', ['澄江化石地博物馆', '广龙抚海湾湿地公园', '湖泉生态园'], '弥勒'],
  ['弥勒', ['东风韵景区', '石林风景区'], '昆明龙湖酒店'],
  ...
  ['腾冲酒店', ['玉龙湖'], '临沧酒店'],
  ['临沧酒店', ['普洱', '西双版纳酒店', '告庄西双景', '星光夜市'], '西双版纳酒店'],
  ['西双版纳酒店', ['野象谷'], '西双版纳酒店'],
  ['西双版纳酒店', ['曼掌村'], '西双版纳酒店'],
  ['西双版纳酒店', ['热带植物园'], '西双版纳酒店'],
  ['西双版纳机场', [], '太原机场', 'fly'],
...
const planB = [
  ...
  ['安顺', ['马岭河'], '兴义'],
  ['兴义', ['万峰林'], '抚仙湖'],
  ['抚仙湖', ['澄江化石地博物馆', '广龙抚海湾湿地公园', '湖泉生态园'], '弥勒'],
  ['弥勒', ['东风韵景区', '石林风景区'], '昆明'],
  ['昆明', [], '昆明'],
  ['昆明', [], '昆明'],
  ['昆明', [], '大理'],
